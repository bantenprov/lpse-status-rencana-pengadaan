...
class CreateStatusRencanaPengadaansTable extends Migration {

	public function up()
	{
		Schema::create('lpse_status_rencana_pengadaans', function(Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::drop('lpse_status_rencana_pengadaans');
	}
}